...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static final String PREF_FILE_NAME = "myMoney_pref";
    ...
    public static List<DrawerListData> getData() {
        List<DrawerListData> data = new ArrayList<>();

        int[] icons = {R.drawable.ic_next, R.drawable.ic_next};
        String[] titles = {"Title1", "Title2"};
        for(int i=0; i<titles.length && i<icons.length; i++) {
            DrawerListData current = new DrawerListData();
